...
impl NetworkType {
    pub fn default_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 12412,
            NetworkType::Testnet => 12512,
            NetworkType::Simnet => 12712,
            NetworkType::Devnet => 12812,
        }
    }

    pub fn default_borsh_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 13412,
            NetworkType::Testnet => 13512,
            NetworkType::Simnet => 13712,
            NetworkType::Devnet => 13812,
        }
    }

    pub fn default_json_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 14412,
            NetworkType::Testnet => 14512,
            NetworkType::Simnet => 14712,
            NetworkType::Devnet => 14812,
        }
    }
...
pub enum NetworkIdError {
    #[error("Invalid network name prefix: {0}. The expected prefix is 'anuma'.")]
...
///
/// NetworkId is a unique identifier for a Anuma network instance.
...
impl NetworkId {
    ...
    pub fn default_p2p_port(&self) -> u16 {
        ...
        match self.network_type {
            NetworkType::Mainnet => 12411,
            NetworkType::Testnet => match self.suffix {
                Some(10) => 12511,
                Some(11) => 12611,
                None | Some(_) => 12711,
            },
            NetworkType::Simnet => 12811,
            NetworkType::Devnet => 12911,
        }
    }
    ...
    /// Returns a textual description of the network prefixed with `anuma-`
    pub fn to_prefixed(&self) -> String {
        format!("anuma-{}", self)
    }

    pub fn from_prefixed(prefixed: &str) -> Result<Self, NetworkIdError> {
        if let Some(stripped) = prefixed.strip_prefix("anuma-") {
