    ...
    let cmd = Command::new("kaspad")
        ...
        .arg(
            Arg::new("rpclisten")
                ...
                .help("Interface:port to listen for gRPC connections (default port: 12412, testnet: 12512)."),
        )
        .arg(
            Arg::new("rpclisten-borsh")
                ...
                .help("Interface:port to listen for wRPC Borsh connections (default port: 13412, testnet: 13512)."),
        ...
        .arg(
            Arg::new("rpclisten-json")
                ...
                .value_parser(clap::value_parser!(WrpcNetAddress))
                .help("Interface:port to listen for wRPC JSON connections (default port: 14412, testnet: 14512)."),
        )
        ...
        .arg(
            Arg::new("listen")
                ...
                .require_equals(true)
                .value_parser(clap::value_parser!(ContextualNetAddress))
                .help("Add an interface:port to listen for connections (default all interfaces port: 12411, testnet: 12511)."),
        )
        .arg(
            Arg::new("outpeers")
                .long("outpeers")
...
/*
  ...
  -a, --addpeer=                            Add a peer to connect with at startup
      ...
      --whitelist=                          Add an IP network or IP that will not be banned. (eg. 192.168.1.0/24 or
                                            ::1)
      --rpclisten=                          Add an interface/port to listen for RPC connections (default port: 12412,
                                            testnet: 12512)
